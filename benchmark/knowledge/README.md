...
| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Faithfulness** | 0.9677 | 0.9825 | 0.9861 | 0.9797 | **0.9925** | 0.7664 | ✅ CrewAI |
| **Answer Relevancy** | 0.9385 | 0.9054 | **0.9543** | 0.9485 | 0.9073 | 0.8544 | ✅ tRPC-Agent-Go |
| **Answer Correctness** | 0.7901 | **0.8499** | 0.8379 | 0.8072 | 0.7608 | 0.6683 | ✅ LangChain-Chain |
| **Answer Similarity** | 0.5329 | **0.5801** | 0.5421 | 0.5421 | 0.5305 | 0.4923 | ✅ LangChain-Chain |

**Context Quality:**

| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Context Precision** | 0.8777 | 0.8817 | **0.8973** | 0.8691 | 0.8665 | 0.8876 | ✅ tRPC-Agent-Go |
| **Context Recall** | 0.9965 | 0.9700 | **1.0000** | 0.9792 | 0.9967 | 0.9933 | ✅ tRPC-Agent-Go |
| **Context Entity Recall** | **0.6467** | 0.6144 | 0.6461 | 0.6416 | 0.6350 | 0.6278 | ✅ LangChain |
...
| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Faithfulness** | 0.9647 | 0.9325 | 0.9716 | 0.9481 | **0.9740** | 0.9130 | ✅ CrewAI |
| **Answer Relevancy** | 0.9063 | 0.7559 | 0.9196 | 0.8754 | 0.9238 | **0.9327** | ✅ AutoGen |
| **Answer Correctness** | 0.7244 | 0.6677 | **0.7494** | 0.6960 | 0.6907 | 0.7330 | ✅ tRPC-Agent-Go |
| **Answer Similarity** | 0.5401 | 0.5417 | **0.5599** | 0.5411 | 0.5508 | 0.5414 | ✅ tRPC-Agent-Go |

**Context Quality:**

| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Context Precision** | 0.2718 | **0.3136** | 0.2886 | 0.2943 | 0.2925 | 0.2816 | ✅ LangChain-Chain |
| **Context Recall** | 0.8776 | 0.7000 | 0.8800 | 0.8083 | **0.9150** | 0.9033 | ✅ CrewAI |
| **Context Entity Recall** | 0.5790 | 0.4917 | 0.5933 | 0.5833 | 0.6167 | **0.6317** | ✅ AutoGen |
...
| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Faithfulness** | **0.9719** | 0.9000 | 0.9608 | 0.9505 | 0.9648 | 0.7810 | ✅ LangChain |
| **Answer Relevancy** | 0.8370 | 0.8697 | **0.9163** | 0.6748 | 0.8594 | 0.7627 | ✅ tRPC-Agent-Go |
| **Answer Correctness** | 0.7226 | 0.7898 | **0.8055** | 0.6148 | 0.6755 | 0.6634 | ✅ tRPC-Agent-Go |
| **Answer Similarity** | 0.5330 | **0.5904** | 0.5462 | 0.5062 | 0.5266 | 0.5058 | ✅ LangChain-Chain |

**Context Quality:**

| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Context Precision** | 0.6329 | **0.7019** | 0.6466 | 0.6050 | 0.6308 | 0.6311 | ✅ LangChain-Chain |
| **Context Recall** | 0.9796 | 0.9300 | **0.9900** | 0.8700 | **0.9900** | **0.9900** | ✅ tRPC-Agent-Go / CrewAI / AutoGen |
| **Context Entity Recall** | 0.7143 | 0.6700 | 0.7100 | 0.6100 | **0.7200** | **0.7200** | ✅ CrewAI / AutoGen |
...
| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Faithfulness** | 0.9681 | 0.9383 | 0.9728 | 0.9594 | **0.9771** | 0.8201 | ✅ CrewAI |
| **Answer Relevancy** | 0.8939 | 0.8437 | **0.9301** | 0.8329 | 0.8968 | 0.8499 | ✅ tRPC-Agent-Go |
| **Answer Correctness** | 0.7457 | 0.7691 | **0.7976** | 0.7060 | 0.7090 | 0.6882 | ✅ tRPC-Agent-Go |
| **Answer Similarity** | 0.5353 | **0.5707** | 0.5494 | 0.5298 | 0.5360 | 0.5132 | ✅ LangChain-Chain |
| **Context Precision** | 0.5941 | **0.6324** | 0.6108 | 0.5895 | 0.5966 | 0.6001 | ✅ LangChain-Chain |
| **Context Recall** | 0.9512 | 0.8667 | 0.9567 | 0.8858 | **0.9672** | 0.9622 | ✅ CrewAI |
| **Context Entity Recall** | 0.6467 | 0.5920 | 0.6498 | 0.6116 | 0.6572 | **0.6598** | ✅ AutoGen |

**Weighted Average Across All 3 Subsets** (en×300 + en_int×100 + en_fact×100, total 500 QA pairs):

| Metric | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno | CrewAI | AutoGen | Best |
|--------|-----------|-----------------|---------------|------|--------|---------|------|
| **Faithfulness** | 0.9679 | 0.9560 | 0.9781 | 0.9675 | **0.9833** | 0.7986 | ✅ CrewAI |
| **Answer Relevancy** | 0.9118 | 0.8684 | **0.9398** | 0.8791 | 0.9010 | 0.8517 | ✅ tRPC-Agent-Go |
| **Answer Correctness** | 0.7635 | 0.8014 | **0.8137** | 0.7465 | 0.7297 | 0.6803 | ✅ tRPC-Agent-Go |
| **Answer Similarity** | 0.5344 | **0.5745** | 0.5465 | 0.5347 | 0.5338 | 0.5048 | ✅ LangChain-Chain |
| **Context Precision** | 0.7076 | **0.7321** | 0.7254 | 0.7013 | 0.7046 | 0.7151 | ✅ LangChain-Chain |
| **Context Recall** | 0.9693 | 0.9080 | 0.9740 | 0.9232 | **0.9790** | 0.9746 | ✅ CrewAI |
| **Context Entity Recall** | 0.6467 | 0.6010 | **0.6483** | 0.6236 | **0.6483** | 0.6470 | ✅ tRPC-Agent-Go / CrewAI |

**Cross-subset Winner Count** (all 6 frameworks across 3 subsets; tied categories with 3+ winners are excluded):

| Framework | 1st Place Count | Strongest Areas |
|-----------|----------------|-----------------|
| **tRPC-Agent-Go** | **7** | Answer Relevancy (en, en_fact), Answer Correctness (en_int, en_fact), Answer Similarity (en_int), Context Precision (en), Context Recall (en) |
| **LangChain-Chain** | **5** | Answer Correctness (en), Answer Similarity (en, en_fact), Context Precision (en_int, en_fact) |
| **CrewAI** | **4** | Faithfulness (en, en_int), Context Recall (en_int), Context Entity Recall (en_fact) |
| **AutoGen** | **2** | Answer Relevancy (en_int), Context Entity Recall (en_int) |
| **LangChain** | **2** | Context Entity Recall (en), Faithfulness (en_fact) |
| **Agno** | **0** | — |

**Key Findings:**

1. **tRPC-Agent-Go leads comprehensively with the most 1st-place finishes (7)**: Ranks 1st in **Answer Relevancy** on average (0.9301), **Answer Correctness** on average (0.7976), plus en_int **Answer Correctness** (0.7494) and **Answer Similarity** (0.5599). Combined with en subset's **Context Precision** (0.8973) and **Context Recall** (1.0000), it is the strongest overall agent-based framework.
2. **LangChain-Chain excels in answer similarity and context precision**: Its deterministic chain pipeline (no agent loop) ranks 1st in **Answer Similarity** (en, en_fact) and **Context Precision** (en_int, en_fact), plus **Answer Correctness** (en). With 5 first-place finishes, it delivers precise, faithful answers.
3. **CrewAI leads in faithfulness and context recall**: **Faithfulness** (en: 0.9925, en_int: 0.9740) and **Context Recall** (en_int: 0.9150) rank 1st, with 4 first-place finishes overall.
4. **Faithfulness is strong across most frameworks**: LangChain, tRPC-Agent-Go, CrewAI, and Agno all achieve > 0.93 faithfulness on average, indicating minimal hallucination. AutoGen (0.82) shows relatively lower faithfulness.
5. **Information Integration (en_int) is the hardest task**: Context Precision drops significantly for all frameworks (0.27-0.31 vs 0.59-0.90 in other subsets), reflecting the inherent difficulty of multi-document reasoning.
6. **Weighted average (by QA count) favors tRPC-Agent-Go further**: In the weighted average (en×300 + en_int×100 + en_fact×100), tRPC-Agent-Go leads in Answer Relevancy (0.9398), Answer Correctness (0.8137), and Context Entity Recall (tied with CrewAI at 0.6483). LangChain-Chain leads in Answer Similarity and Context Precision. CrewAI leads in Faithfulness and Context Recall.
