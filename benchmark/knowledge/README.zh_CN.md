...
| 指标                            | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno       | CrewAI     | AutoGen | 胜者             |
| --------------------------------- | ----------- | ----------------- | --------------- | ------------ | ------------ | --------- | ------------------ |
| **Faithfulness (忠实度)**       | 0.9677    | 0.9825          | 0.9861        | 0.9797     | **0.9925** | 0.7664  | ✅ CrewAI        |
| **Answer Relevancy (相关性)**   | 0.9385    | 0.9054          | **0.9543**    | 0.9485     | 0.9073     | 0.8544  | ✅ tRPC-Agent-Go |
| **Answer Correctness (正确性)** | 0.7901    | **0.8499**      | 0.8379        | 0.8072     | 0.7608     | 0.6683  | ✅ LangChain-Chain |
| **Answer Similarity (相似度)**  | 0.5329    | **0.5801**      | 0.5421        | 0.5421     | 0.5305     | 0.4923  | ✅ LangChain-Chain |
...
| 指标                                 | LangChain  | LangChain-Chain | tRPC-Agent-Go  | Agno   | CrewAI | AutoGen | 胜者             |
| -------------------------------------- | ------------ | ----------------- | ---------------- | -------- | -------- | --------- | ------------------ |
| **Context Precision (精确率)**       | 0.8777     | 0.8817          | **0.8973**     | 0.8691 | 0.8665 | 0.8876  | ✅ tRPC-Agent-Go |
| **Context Recall (召回率)**          | 0.9965     | 0.9700          | **1.0000**     | 0.9792 | 0.9967 | 0.9933  | ✅ tRPC-Agent-Go |
| **Context Entity Recall (实体召回)** | **0.6467** | 0.6144          | 0.6461         | 0.6416 | 0.6350 | 0.6278  | ✅ LangChain     |
...
| 指标                            | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno   | CrewAI     | AutoGen    | 胜者             |
| --------------------------------- | ----------- | ----------------- | --------------- | -------- | ------------ | ------------ | ------------------ |
| **Faithfulness (忠实度)**       | 0.9647    | 0.9325          | 0.9716        | 0.9481 | **0.9740** | 0.9130     | ✅ CrewAI        |
| **Answer Relevancy (相关性)**   | 0.9063    | 0.7559          | 0.9196        | 0.8754 | 0.9238     | **0.9327** | ✅ AutoGen       |
| **Answer Correctness (正确性)** | 0.7244    | 0.6677          | **0.7494**    | 0.6960 | 0.6907     | 0.7330     | ✅ tRPC-Agent-Go |
| **Answer Similarity (相似度)**  | 0.5401    | 0.5417          | **0.5599**    | 0.5411 | 0.5508     | 0.5414     | ✅ tRPC-Agent-Go |
...
| 指标                                 | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno   | CrewAI     | AutoGen    | 胜者               |
| -------------------------------------- | ----------- | ----------------- | --------------- | -------- | ------------ | ------------ | -------------------- |
| **Context Precision (精确率)**       | 0.2718    | **0.3136**      | 0.2886        | 0.2943 | 0.2925     | 0.2816     | ✅ LangChain-Chain |
| **Context Recall (召回率)**          | 0.8776    | 0.7000          | 0.8800        | 0.8083 | **0.9150** | 0.9033     | ✅ CrewAI          |
| **Context Entity Recall (实体召回)** | 0.5790    | 0.4917          | 0.5933        | 0.5833 | 0.6167     | **0.6317** | ✅ AutoGen         |
...
| 指标                            | LangChain  | LangChain-Chain | tRPC-Agent-Go | Agno   | CrewAI | AutoGen | 胜者             |
| --------------------------------- | ------------ | ----------------- | --------------- | -------- | -------- | --------- | ------------------ |
| **Faithfulness (忠实度)**       | **0.9719** | 0.9000          | 0.9608        | 0.9505 | 0.9648 | 0.7810  | ✅ LangChain     |
| **Answer Relevancy (相关性)**   | 0.8370     | 0.8697          | **0.9163**    | 0.6748 | 0.8594 | 0.7627  | ✅ tRPC-Agent-Go |
| **Answer Correctness (正确性)** | 0.7226     | 0.7898          | **0.8055**    | 0.6148 | 0.6755 | 0.6634  | ✅ tRPC-Agent-Go |
| **Answer Similarity (相似度)**  | 0.5330     | **0.5904**      | 0.5462        | 0.5062 | 0.5266 | 0.5058  | ✅ LangChain-Chain |
...
| 指标                                 | LangChain | LangChain-Chain | tRPC-Agent-Go  | Agno   | CrewAI     | AutoGen    | 胜者                                |
| -------------------------------------- | ----------- | ----------------- | ---------------- | -------- | ------------ | ------------ | ------------------------------------- |
| **Context Precision (精确率)**       | 0.6329    | **0.7019**      | 0.6466         | 0.6050 | 0.6308     | 0.6311     | ✅ LangChain-Chain                  |
| **Context Recall (召回率)**          | 0.9796    | 0.9300          | **0.9900**     | 0.8700 | **0.9900** | **0.9900** | ✅ tRPC-Agent-Go / CrewAI / AutoGen |
| **Context Entity Recall (实体召回)** | 0.7143    | 0.6700          | 0.7100         | 0.6100 | **0.7200** | **0.7200** | ✅ CrewAI / AutoGen                 |
...
| 指标                                 | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno   | CrewAI     | AutoGen | 胜者               |
| -------------------------------------- | ----------- | ----------------- | --------------- | -------- | ------------ | --------- | -------------------- |
| **Faithfulness (忠实度)**            | 0.9681    | 0.9383          | 0.9728        | 0.9594 | **0.9771** | 0.8201  | ✅ CrewAI          |
| **Answer Relevancy (相关性)**        | 0.8939    | 0.8437          | **0.9301**    | 0.8329 | 0.8968     | 0.8499  | ✅ tRPC-Agent-Go   |
| **Answer Correctness (正确性)**      | 0.7457    | 0.7691          | **0.7976**    | 0.7060 | 0.7090     | 0.6882  | ✅ tRPC-Agent-Go   |
| **Answer Similarity (相似度)**       | 0.5353    | **0.5707**      | 0.5494        | 0.5298 | 0.5360     | 0.5132  | ✅ LangChain-Chain |
| **Context Precision (精确率)**       | 0.5941    | **0.6324**      | 0.6108        | 0.5895 | 0.5966     | 0.6001  | ✅ LangChain-Chain |
| **Context Recall (召回率)**          | 0.9512    | 0.8667          | 0.9567        | 0.8858 | **0.9672** | 0.9622  | ✅ CrewAI          |
| **Context Entity Recall (实体召回)** | 0.6467    | 0.5920          | 0.6498        | 0.6116 | 0.6572     | **0.6598** | ✅ AutoGen       |
...
| 指标                                 | LangChain | LangChain-Chain | tRPC-Agent-Go | Agno   | CrewAI     | AutoGen | 胜者               |
| -------------------------------------- | ----------- | ----------------- | --------------- | -------- | ------------ | --------- | -------------------- |
| **Faithfulness (忠实度)**            | 0.9679    | 0.9560          | 0.9781        | 0.9675 | **0.9833** | 0.7986  | ✅ CrewAI          |
| **Answer Relevancy (相关性)**        | 0.9118    | 0.8684          | **0.9398**    | 0.8791 | 0.9010     | 0.8517  | ✅ tRPC-Agent-Go   |
| **Answer Correctness (正确性)**      | 0.7635    | 0.8014          | **0.8137**    | 0.7465 | 0.7297     | 0.6803  | ✅ tRPC-Agent-Go   |
| **Answer Similarity (相似度)**       | 0.5344    | **0.5745**      | 0.5465        | 0.5347 | 0.5338     | 0.5048  | ✅ LangChain-Chain |
| **Context Precision (精确率)**       | 0.7076    | **0.7321**      | 0.7254        | 0.7013 | 0.7046     | 0.7151  | ✅ LangChain-Chain |
| **Context Recall (召回率)**          | 0.9693    | 0.9080          | 0.9740        | 0.9232 | **0.9790** | 0.9746  | ✅ CrewAI          |
| **Context Entity Recall (实体召回)** | 0.6467    | 0.6010          | **0.6483**    | 0.6236 | **0.6483** | 0.6470  | ✅ tRPC-Agent-Go / CrewAI |

**各子集第一名统计**（6 个框架参与 3 个子集；3 方及以上并列的类别不计入）：
...
1. **tRPC-Agent-Go 以 7 次第一名全面领先**：平均 **Answer Relevancy** (0.9301) 和 **Answer Correctness** (0.7976) 均为第一，加上 en_int 子集的 **Answer Correctness** (0.7494) 和 **Answer Similarity** (0.5599)，以及 en 子集的 **Context Precision** (0.8973) 和 **Context Recall** (1.0000)，是综合表现最强的 Agent 框架。
2. **LangChain-Chain 在答案相似度和上下文精确率上表现优异**：en 和 en_fact 子集 **Answer Similarity** 均为第一，加上 **Context Precision** (en_int, en_fact) 和 **Answer Correctness** (en)。以 5 次第一名，展现出精准、忠实的回答能力。
3. **CrewAI 忠实度和上下文召回表现突出**：**Faithfulness** (en: 0.9925, en_int: 0.9740) 和 **Context Recall** (en_int: 0.9150) 均为第一，以 4 次第一名排名第三。
4. **整体忠实度较高**：LangChain、tRPC-Agent-Go、CrewAI 和 Agno 的平均 Faithfulness 均 > 0.93，表明幻觉问题较少。AutoGen (0.82) 忠实度相对偏低。
5. **信息整合 (en_int) 是最难的任务**：所有框架的 Context Precision 显著下降（0.27-0.31 vs 其他子集的 0.59-0.90），反映了多文档推理的固有难度。
6. **加权平均（按 QA 数量）进一步突出 tRPC-Agent-Go 优势**：在加权平均（en×300 + en_int×100 + en_fact×100）中，tRPC-Agent-Go 在 Answer Relevancy (0.9398)、Answer Correctness (0.8137) 和 Context Entity Recall（与 CrewAI 并列 0.6483）领先。LangChain-Chain 在 Answer Similarity 和 Context Precision 领先。CrewAI 在 Faithfulness 和 Context Recall 领先。
